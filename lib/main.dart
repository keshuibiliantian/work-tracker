              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Radio<String>(value: 'work', groupValue: isRest ? 'rest' : 'work', onChanged: (v) => setDialogState(() => isRest = false)),
                        const Text('上班', style: TextStyle(fontSize: 18)),
                        Radio<String>(value: 'rest', groupValue: isRest ? 'rest' : 'work', onChanged: (v) => setDialogState(() => isRest = true)),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFEFF6FF), foregroundColor: const Color(0xFF3B82F6), textStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                              onPressed: calcHours,
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: Color(0xFF3B82F6))),
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isOtherMonth ? const Color(0xFFCBD5E1) : isToday ? const Color(0xFF3B82F6) : const Color(0xFF1E293B),
                            ),
                          ),
                          if (data != null) ...[
